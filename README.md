...
🏗️ Conception et développement d'une **plateforme web & mobile sécurisée** pour la digitalisation du **suivi des projets d'infrastructure routière** du Ministère des Infrastructures, Travaux Publics, Affaires Foncières, Urbanisme et Habitat de la ville de Kinshasa (RDC).
...
#### 3. Reporting quotidien des agents de terrain
...
#### 9. Paiement et gestion d'abonnement
...
🏗️ Conception et développement d'une plateforme de trading binaire et multi-options basée sur l'algorithme LMSR (Logarithmic Market Scoring Rule). Un écosystème Fintech complet gérant des flux financiers réels, de la liquidité algorithmique et une haute sécurité transactionnelle.
...
| 📐 Advanced Survey Solution for CAPI | Asian Development Bank | 2022 |
| 🤖 AI / ML / Deep Learning | Amazon Web Services (AWS) | 2022 |
| 🧪 Machine Learning Terminology & Process | Amazon Web Services (AWS) | 2022 |
| 🔬 Development Research in Practice | DIME · Banque Mondiale | 2021 |
| 📈 Manage Successful Impact Evaluation Survey | DIME · Banque Mondiale | 2021 |
| 🐧 Administration Systèmes & Réseaux sous Debian | La Maison du Savoir | 2015 |
