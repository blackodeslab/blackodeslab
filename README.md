...
#### A. Conception et développement d'une **plateforme web & mobile sécurisée** pour la digitalisation du **suivi des projets d'infrastructure routière** du Ministère des Infrastructures, Travaux Publics, Affaires Foncières, Urbanisme et Habitat de la ville de Kinshasa (RDC).
...
#### B. Conception et développement d'une plateforme de trading binaire et multi-options basée sur l'algorithme LMSR (Logarithmic Market Scoring Rule). Un écosystème Fintech complet gérant des flux financiers réels, de la liquidité algorithmique et une haute sécurité transactionnelle.
